...
SECRET_KEY = 'django-insecure-wdulj#j@e^-y=b8ccd2h@$lug$r86^$ir&)s=wh=1_0z5^m_ui'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'vendas/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'vendas/static'),
]
